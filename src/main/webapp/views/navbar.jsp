...
<header>
	...
	<c:set var="ingreso"
		value="${not empty sessionScope.ingreso and sessionScope.ingreso}" />
					...
					<c:choose>
						<c:when test="${ingreso}">
							...
							<li class="nav-item dropdown ms-2"><a
								...
								href="#"> <i class="bi bi-plus-circle"></i> Crear ${navText == 'Capacitacion' ? 'Capacitación': ''}
									${navText == 'Usuario' ? 'Usuario': ''}
							</a>
								<ul class="dropdown-menu bg-dark">
									<li><a class="dropdown-item" href="CrearCapacitacion">
											<i class="bi bi-file-plus"></i> Crear Capacitación
									</a></li>
									<li><a class="dropdown-item" href="CrearUsuario"> <i
											class="bi bi-person-plus"></i> Crear Usuario
									</a></li>
								</ul></li>
							<li class="nav-item dropdown ms-2"><a
								class="nav-link dropdown-toggle ${navItem == 'Listar' ? 'active' : ''}"
								id="navbarDropdown" role="button" data-bs-toggle="dropdown"
								href="#"> <i class="bi bi-card-list"></i> Listar ${navText == 'Capacitaciones' ? 'Capacitaciones' : ''}
								...
								<ul class="dropdown-menu bg-dark">
									...
									<li><a class="dropdown-item" href="ListadoUsuarios"> <i
											class="bi bi-people"></i> Listar Usuarios
									</a></li>
								</ul></li>
						</c:when>
						<c:otherwise>
							...
							<li class="nav-item"><a
								class="nav-link ${navItem == 'Login' ? 'active' : ''}"
								href="Login"> <i class="bi bi-box-arrow-in-left ms-2"></i>
									Login
							</a></li>
						</c:otherwise>
					</c:choose>
				...
				<ul class="navbar-nav flex-row flex-wrap text-light">
					<c:if test="${ingreso}">
						<li class="nav-item dropdown"><a
							...
							role="button" data-bs-toggle="dropdown" href="#"> <i
								class="bi bi-person-circle"></i> ${nombreUsuario}
						</a>
							<ul class="dropdown-menu dropdown-menu-end bg-dark">
								<li><a class="dropdown-item" href="CerrarSession"> <i
